<div x-data="{ open: false }" class="relative">
    <button @click="open = !open" type="button" class="relative p-2 rounded-lg hover:bg-white/10 transition" title="<?php echo e(__('Notifications')); ?>">
    ...
    <div x-show="open" 
        ...
        <div class="p-4 border-b border-slate-200 flex items-center justify-between">
            <div>
                <h3 class="text-sm font-semibold text-slate-900"><?php echo e(__('Notifications')); ?></h3>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($unreadCount > 0): ?>
                    <p class="text-xs text-slate-500 mt-1"><?php echo e($unreadCount); ?> <?php echo e(__('unread')); ?></p>
                <?php else: ?>
                    <p class="text-xs text-slate-500 mt-1"><?php echo e(__('No new notifications')); ?></p>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            <a href="<?php echo e(route('notifications.index')); ?>" class="text-xs text-primary-blue hover:underline"><?php echo e(__('View All')); ?></a>
        </div>
        ...
        <div class="max-h-96 overflow-y-auto">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($notifications->count() > 0): ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <a href="<?php echo e(route('notifications.index')); ?>#<?php echo e($notification->type); ?>" class="block p-4 hover:bg-slate-50 border-b border-slate-100 last:border-b-0 <?php echo e(! $notification->read_at ? 'bg-blue-50/50' : ''); ?>">
                        <div class="flex items-start gap-3">
                            <div class="flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center <?php echo e($notification->type === 'low_stock' ? 'bg-red-100' : ($notification->type === 'expiry_warning' ? 'bg-amber-100' : 'bg-blue-100')); ?>">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($notification->type === 'low_stock'): ?>
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-xs text-slate-600 mt-0.5"><?php echo e($notification->message); ?></p>
            ...
            <?php else: ?>
                <div class="p-8 text-center">
                    ...
                    <p class="text-sm text-slate-500"><?php echo e(__('No notifications')); ?></p>
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\Cshop\resources\views/components/notification-bell.blade.php ENDPATH**/ ?>