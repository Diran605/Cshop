<div class="ui-page">
    <div class="ui-page-container">
        <div class="mb-6">
            <h2 class="ui-page-title">{{ __('Categories') }}</h2>
            <div class="ui-page-subtitle">{{ __('Organize products into categories.') }}</div>
        </div>
                ...
                <div class="ui-card-body">
                    <div class="flex items-center justify-between gap-4">
                        <div class="w-full max-w-md">
                            ...
                            <input type="text" wire:model.live.debounce.300ms="search" class="mt-1 ui-input" placeholder="Search categories..." />
                        </div>
                    </div>
                        ...
                        <table class="ui-table">
                            ...
                            <tbody>
                                    ...
                                    <tr wire:key="category-{{ $category->id }}">
                                        ...
                                        <td class="px-4 py-3 text-sm text-right">
                                            <div class="inline-flex items-center gap-3">
                                                <button type="button" wire:click.stop.prevent="openEditModal({{ $category->id }})" class="ui-btn-link">{{ __('Edit') }}</button>
                                                <button type="button" wire:click.stop.prevent="openDeleteModal({{ $category->id }})" class="ui-btn-link-danger">{{ __('Delete') }}</button>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
                                ...
                                @if ($categories->isEmpty())
                                    <tr>
                                        <td colspan="{{ $isSuperAdmin ? 3 : 2 }}" class="ui-table-empty">{{ __('No categories found.') }}</td>
                                    </tr>
                                @endif
                            </tbody>
                        </table>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center" data-modal-root>
            ...
            <div class="relative w-full max-w-lg mx-4 ui-card">
                <div class="p-4 border-b border-slate-200">
                    ...
                    <div class="mt-1 font-semibold text-slate-900">{{ __('Delete Category') }}</div>
                </div>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center" data-modal-root>
            ...
            <div class="relative w-full max-w-lg mx-4 ui-card">
                <div class="p-4 border-b border-slate-200 flex items-center justify-between">
                    <div>
                        <div class="text-sm text-slate-500">{{ __('Edit Category') }}</div>
