                ...
                <div class="ui-card-body">
                    <div class="flex items-center justify-between gap-4">
                        <div class="w-full max-w-md">
                            ...
                            <input type="text" wire:model.live.debounce.300ms="search" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="Search bulk types..." />
                        </div>
                    </div>
                        ...
                        <table class="ui-table">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                @if ($bulkTypes->isEmpty())
                                    <tr>
                                        <td colspan="{{ $isSuperAdmin ? 5 : 4 }}" class="px-4 py-8 text-center text-sm text-gray-500">{{ __('No bulk types found.') }}</td>
                                    </tr>
                                @endif
                            </tbody>
                        </table>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center" data-modal-root>
            ...
            <div class="relative w-full max-w-lg mx-4 ui-card">
                <div class="p-4 border-b border-gray-200">
                    ...
                    <div class="mt-1 font-semibold text-gray-900">{{ __('Delete Bulk Type') }}</div>
                </div>
