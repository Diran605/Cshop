        ...
        <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-6">
            ...
            <div class="ui-card">
                <div class="ui-card-body">
                    ...
                    <div class="mt-1 text-2xl font-semibold text-slate-900">{{ number_format((float) $profitMargin, 2) }}%</div>
                </div>
            </div>
            ...
            <div class="ui-card">
                <div class="ui-card-body">
                    ...
                    <div class="mt-1 text-2xl font-semibold text-slate-900">{{ number_format((int) $lowProfitLines) }}</div>
                </div>
            </div>
            ...
            <div class="ui-card">
                <div class="ui-card-body">
                    ...
                    <div class="mt-1 text-2xl font-semibold text-slate-900">{{ number_format((int) $lossLines) }}</div>
                </div>
            </div>
        </div>
