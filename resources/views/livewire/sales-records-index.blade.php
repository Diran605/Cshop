                ...
                <table class="ui-table text-sm">
                    ...
                    <tbody>
                        @forelse ($receipts as $receipt)
                            <tr wire:key="sale-{{ $receipt->id }}" class="{{ $receipt->voided_at ? 'bg-red-50 opacity-60' : '' }}">
                                @can('sales_records.batch_print')
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4" data-modal-root>
            ...
            <div class="relative w-full max-w-md ui-card">
                <div class="p-4 border-b border-slate-200">
                    <div class="flex items-center justify-between">
                        <div class="text-lg font-semibold text-red-600">{{ __('Void Sale') }}</div>
                    ...
                    <div class="bg-red-50 border border-red-200 rounded-lg p-3">
                        <div class="flex items-start gap-2">
                            ...
                            <div class="text-sm text-red-800">
                                {{ __('This action will void the sale and restore stock to inventory. This cannot be undone.') }}
                            </div>
                        </div>
                    </div>

                    <div>
                        <label class="ui-label">{{ __('Void Reason') }}</label>
                        <textarea wire:model.live="void_reason" rows="3" class="mt-1 ui-input" placeholder="{{ __('Enter reason for voiding this sale...') }}"></textarea>
                        @error('void_reason')
                ...
                <div class="p-4 border-t border-slate-200 flex justify-end gap-3">
                    ...
                    <button type="button" wire:click="confirmVoidSale" class="ui-btn-danger">
                        {{ __('Confirm Void') }}
                    </button>
                </div>
            </div>
